...
Once you have completed your [(First Time Setup)](plmxml_specific_export_considerations.md) you still may need to take a few things into account when doing a PLMXML Export, that are different from the standard Export Process.
