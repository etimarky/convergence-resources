...
* Steps:
  * SmartClass
    * Set up the Contextual Attribution Category
      ...
      * ![](.gitbook/assets/Contextual_Category.png)
    * Set up the Contextual Attribute
      * Data Type: Custom
      * CustomData: MultiVal
      * Contextual Attribution Category: _select the category created in the previous step_![](.gitbook/assets/Contextual_Attribute.png)
  ...
  * SmartFind
    ...
    * This will create a new tab. The tab will have the same name as the contextual attribute![](.gitbook/assets/Contextual_Selection_Item_Details.png)
    *   Click on the tab to view the attributes that differ depending on the selection made

        * Click on the drop down to select the different contexts to view or edit![](.gitbook/assets/Brand_Drop_Down.png)

        ![](.gitbook/assets/Brand_A.png)

        ![](.gitbook/assets/Brand_B.png)

        ![](.gitbook/assets/Brand_C.png)
