...
1. When on the item details page on the left-hand side you will see the filter called "Validation Type", click the plus sign next to the filter to expand the list of filterable values. 
...
The user can then click NONE, which will filter the items that do not have violation for that attribute.
