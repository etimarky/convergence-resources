...
2. Click on Actions to the right of the category that you are merging (*i.e. the originating category*)


![](assets/image_112.png)




3. Click on Merge From (*a merge selection icon will appear next to Actions)*


![](assets/image_113.png)




4. Click on Actions to the right of the category that you are merging to (*i.e. the destination category*)


5. Click on Merge To


![](assets/image_114.png)




6. De-select any attributes that you do not want to add to the new category (*Note: This purges any values associated with that attribute in the original category*)


![](assets/image_115.png)
