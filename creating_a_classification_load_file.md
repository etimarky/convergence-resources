...
Unit of Measure
If they are not listed in the Excel spreadsheet exactly as they appear in Convergence PIM, the auto-mapping will not recognize it and the user will have to manually select the column headers from a drop down list.   
